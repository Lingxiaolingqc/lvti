...
const questions = [
  q("q01", "RP", "R", "I feel loved when someone creates a special moment just for us.", "当对方为我们创造一个特别的时刻时，我会很有被爱的感觉。"),
  q("q02", "RP", "P", "For me, daily reliability matters more than romantic surprises.", "对我来说，日常的可靠比浪漫惊喜更重要。"),
  q("q03", "RP", "R", "Small romantic gestures can stay in my mind for a long time.", "一些小小的浪漫表达会让我记很久。"),
  q("q04", "RP", "P", "I care more about whether a relationship works in real life than whether it feels like a movie.", "比起像电影一样浪漫，我更在意一段关系在现实生活中是否合适。"),
  q("q05", "RP", "R", "I like love to have a sense of magic or destiny.", "我喜欢爱情里有一点命中注定或奇妙感。"),
  q("q06", "RP", "P", "A good match should first make sense in everyday life.", "一段合适的关系首先应该在日常生活中说得通。"),
  q("q07", "RP", "R", "I care about the emotional meaning behind gifts or messages.", "我很在意礼物或消息背后的情感意义。"),
  q("q08", "RP", "P", "I would rather have practical support than dramatic declarations of love.", "比起轰轰烈烈的表白，我更想要实际的支持。"),
  q("q09", "RP", "R", "I enjoy little rituals in love, like anniversaries, songs, or meaningful places.", "我喜欢爱情里的小仪式感，比如纪念日、某首歌或有意义的地点。"),
  q("q10", "RP", "P", "Before getting deeply attached, I think about whether our lifestyles fit.", "在投入很深之前，我会考虑彼此的生活方式是否合适。"),
  q("q11", "SF", "S", "I feel safer when I know where a relationship is heading.", "当我清楚一段关系会走向哪里时，我会更有安全感。"),
  q("q12", "SF", "F", "I prefer relationships that leave enough room for personal freedom.", "我更喜欢能保留足够个人自由的关系。"),
  ...
  q("q15", "SF", "S", "Consistency matters a lot to me when I start caring about someone.", "当我开始在意一个人时，稳定一致的态度对我很重要。"),
  ...
  q("q19", "SF", "S", "I value loyalty and dependability more than constant excitement.", "比起持续的新鲜刺激，我更看重忠诚和可靠。"),
  q("q20", "SF", "F", "A relationship feels better when both people can still explore who they are.", "如果两个人仍然能探索自己的生活和可能性，这段关系会让我感觉更好。"),
  q("q21", "DI", "D", "When I like someone, I prefer making my feelings clear.", "当我喜欢一个人时，我更倾向于把感觉表达清楚。"),
  ...
  q("q29", "DI", "D", "I appreciate clear answers, even when they are not exactly what I hoped for.", "即使答案不完全如我所愿，我也会欣赏清楚直接的回应。"),
  ...
  q("q34", "EC", "C", "I usually need time to think before making emotional decisions.", "在做情感决定前，我通常需要时间思考。"),
  q("q35", "EC", "E", "I want love to feel emotionally alive, not just peaceful.", "我希望爱情是有情绪生命力的，而不只是平静。"),
